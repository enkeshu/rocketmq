...
public class DefaultRequestProcessor extends AsyncNettyRequestProcessor implements NettyRequestProcessor {
    ...
    public RemotingCommand processRequest(ChannelHandlerContext ctx,
        ...
        switch (request.getCode()) {
            ...
            case RequestCode.GET_KV_CONFIG://获取配置信息
                return this.getKVConfig(ctx, request);
            case RequestCode.DELETE_KV_CONFIG://删除配置信息
                return this.deleteKVConfig(ctx, request);
            case RequestCode.QUERY_DATA_VERSION://获取topic配置信息
                return queryBrokerTopicConfig(ctx, request);
            case RequestCode.REGISTER_BROKER://注册broker信息
            ...
            case RequestCode.GET_ROUTEINTO_BY_TOPIC://更具topic获取路由喜喜
                return this.getRouteInfoByTopic(ctx, request);
            case RequestCode.GET_BROKER_CLUSTER_INFO://获取broker节点信息
